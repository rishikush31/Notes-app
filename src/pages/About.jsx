  ...
  return (
    ...
    <div className='content'>
      <section className='what'>
        ...
        <div className='what-text'>This is a Notes making website created by <a href='https://www.linkedin.com/in/rishi-srivastava-38b8a6237/' rel="noreferrer" target="_blank" >Rishi Srivastava</a>. It was created with React technology and using Mongo Database. We also provide facility of profile picture management. User can check the source code at <a href='https://github.com/rishikush31/Notes-app' rel="noreferrer" target="_blank" >notesapp.code</a> .<br/><br/> All the external sources are used for eductational purpose only. The creator doesnot seek any professional or commercial benefit from the website. Creator does not claim any logo and picture used in website production. User can contact creator on [rishikush31@gmail.com] or <a href='https://www.linkedin.com/in/rishi-srivastava-38b8a6237/' rel="noreferrer" target="_blank" >LinkedIn</a>. <br/><br/>Any further reproduction or copying of the content of this website is subject to copyright protection under the Copright Act 1968.</div>
      </section>
